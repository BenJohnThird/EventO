...
$(document).on('click','#btn_viewReservation', function (){
  var id=$(this).data("id5");
  $.ajax({
    type:'POST',
...
$(document).on('click','#btn_verifyReservation', function (){
  var id=$(this).data("id5");
  var situation = 'Verified | Waiting for the event';
  $.ajax({
    type:'POST',
    url:'Event-Reservation-Verify.php',
