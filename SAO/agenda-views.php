  ...
  <div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <form class="form-horizontal" method="POST" action="editEventTitle.php">
      ...
      <div class="modal-body">
        ...
        <div class="col-sm-10">
          <input type="text" readonly name="proponent" class="form-control" id="proponent" placeholder="Proponent">
        </div>
        </div>
        <div class="form-group">
        <label for="place" class="col-sm-2 control-label">Venue</label>
        <div class="col-sm-10">
          <input type="text" readonly name="place" class="form-control" id="place" placeholder="Place">
        </div>
        </div>
        <div class="form-group">
