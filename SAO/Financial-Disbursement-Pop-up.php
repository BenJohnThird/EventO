	 	...
	 	<div class="form-group">
	      ...
	      <div class="form-group">
	       <div class ="Name" style ="text-align:center; align-items:center;">
	          <button type= "button" id ="btn_add-FinancialDisbursement" data-id5="'.$row["Reserve"].'" class = 
	          "btn btn-sm  btn-primary">Update</button>
	          <input name="reset" type="reset" id = "btn_reset" class = "btn btn-sm btn-default"/>
	        </div>
	      </div>';
	    echo' </form>';
	 }
 ...
 else
 {
 	echo'<form>
 	   <div class="form-group">
	      ...
	      <div class="form-group">
	       <div class ="Name" style ="text-align:center; align-items:center;">
	          <button type= "button" id ="btn_add-FinancialDisbursement" data-id5="'.$row["Reserve"].'" class = "btn btn-sm btn-primary">Update</button>
