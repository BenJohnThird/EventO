...
while($row = mysqli_fetch_array($result)){
    ...
    <form>
        ...
        <div class="form-group">
          ...
          <input required type = "text" placeholder ="Proponent" id = "proponent" name = "Proponent" size = "20" readonly value ="'.$row["proponent"].'" maxlength = "200" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <select required readonly class = "form-control" id = "sy-select">
        ...
        <div class="form-group">
         ...
         <div class="form-group">  
            ...
            <button type="button" name = "btn_update" id ="btn_update" class = "btn btn-primary" data-idunique = "'.$row["id"].'">Save Changes</button>
            <input name="reset" class = "btn btn-danger" type="reset" id = "btn_reset" />
        </div>
      </div>
     </form>';
	}
