  ...
  <!-- Modal content-->
      <div class="modal-content">
        ...
        <div class="form-group">
          ...
          <input required type = "text" placeholder ="Title" id = "title" name = "Title" size = "20" readonly maxlength = "60" value ="'.$row["title"].'" class="form-control">
        </div>
        <div class="form-group">
          <label for="Room">Proponent:</label>
          <input required type = "text" placeholder ="Proponent" id = "proponent" name = "Proponent" readonly size = "20" value ="'.$row["proponent"].'" maxlength = "200" class="form-control">
        </div>
        <div class="form-group">
          <label for="Room">Place:</label>
          <input required type = "text" placeholder ="Place" id = "place" name = "Place" size = "20" readonly value ="'.$row["place"].'" maxlength = "200" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group" style="margin-bottom:100px;">
	        <div class="col-xs-6">
	          ...
	          <input required type = "time" id = "starttime" name = "StartTime" size = "20" maxlength = "60" readonly value = "'.substr($row["start"], 11).'" class ="form-control">
	        </div>
	        <div class="col-xs-6">
	          <label for="Room">End time:</label>
	          <input required type = "time"  id = "endtime" name = "EndTime" size = "20" maxlength = "60"  readonly value = "'.substr($row["end"],11).'" class ="form-control">
	        </div>
        </div>
        <hr>
        <div class="form-group">
