...
where ap_financial_report.ID = '".$_POST["ReportID"]."' group by title";
	 ...
	 <div class="form-group">
	      ...
	      <div class="form-group">
	       <div class ="Name" style ="text-align:center; align-items:center;">
	          <button type= "button" id ="btn_add-FinancialReport" data-id6="'.$row["Reserve"].'" class = "btn btn-sm btn-primary">Update</button>
