...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 24, 2018 at 05:17 AM
...
(3, 'Hi Crush', 'Pending', '', 'Co/Extra-Curricular', 'Inside', 'Hi Crushh', 'BSIT', 'Monday and Tuesday', '32', 95, 'Love', '95', 'Passed', 'Requesting Subsidy for Venue(s) Only', '', 33, 0),
...
(89, 'Anata', NULL, '2018-02-14 00:00:00', '2018-02-14 00:00:00', '9th Floor', 'JPCS', '2nd Semester', 'Verified by Organization Adviser', 'Change your Title', 3, NULL),
...
(92, 'Must not go', NULL, '2018-02-23 00:00:00', '2018-02-24 00:00:00', '10th Floor', 'JPCS', '2nd Semester', 'Verified by Organization Adviser', 'Noice', 3, NULL),
(93, 'Makati Research Defense', NULL, '2018-03-02 00:00:00', '2018-03-03 00:00:00', 'CEU SAC GP', 'CSIT', '2nd Semester', 'Pending', 'Success', 5, NULL);
...
--
ALTER TABLE `ap_expenses`
  MODIFY `ID` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
...
--
ALTER TABLE `mbl_user_school_individual`
  MODIFY `idmbl_user_school_individual` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `student_council`
  MODIFY `idstudent_council` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
