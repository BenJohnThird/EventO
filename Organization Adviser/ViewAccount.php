...
include ("Connection.php");
    ...
    $hashed = hash('sha512',$salted);
      ...
      $sqlUpdateOrgAdviser = "UPDATE `org_adviser` SET `Lastname`='$lastname',`Firstname`='$firstname',`Middlename`='$middlename' where org_adviser.users_ID ='".$_SESSION["User"]."'";
      if(mysqli_query($conn, $sqlUpdateOrgAdviser))
       {
    ...
    <div class="col-sm-8 text-left" >
      ...
      <div class = "container">
        <div class = "col-sm-10">
          ...
          <?php
            $sql = "SELECT Username,Lastname,Firstname,Middlename,Email from users inner join org_adviser on org_adviser.users_ID = users.ID 
            where ID = '".$_SESSION["User"]."'";
                    ...
                    while($row = mysqli_fetch_array($result))
                    {
                     ...
                     <h3><span class="glyphicon glyphicon-user" aria-hidden="true"></span> School Profile</h3>
                      ...
                      <div class="form-group row">
                         ...
                         <div class="col-sm-10">
                           <input type="text" readonly name = "position" class="form-control" value = "Orgnization Adviser" id="inputEmail3" placeholder="Position">
                         </div>
                       </div>
                       <div class="form-group row">
