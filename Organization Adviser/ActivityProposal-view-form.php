...
$sql = "SELECT * FROM ((events INNER JOIN activityproposal ON events.id = activityproposal.events_id) INNER JOIN users ON events.created = users.ID) where activityproposal.ap_id = '".$_POST["id"]."'";
...
while($row = mysqli_fetch_array($result)){
	echo '
        ...
        <div class="form-group">  
            ...
            <button name = "btn_update" id ="btn_update" data-idunique = "'.$row["ap_id"].'">Update</button>
