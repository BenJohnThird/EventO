      ...
      <div class = "container">
        <div class = "col-sm-10">
          <div style="border-bottom: 5%;">
            <h3><span class="glyphicon glyphicon-user" aria-hidden="true"></span> Your Student Council</h3>
            <div id = "student-council-table"></div>
            <hr>
          </div>
        </div>
      </div>
...
$(document).ready(function(){
  ...
  function fetchStudentCouncil() {
    $.ajax({
    url:"Student-Council-Index-Select.php",
    method:"POST",
    success:function(data){
        $('#student-council-table').html(data);
      }
  });
  }
  fetchStudentCouncil();
