...
<div class="container-fluid text-center">
  <div class="row content">
      <?php include ('Financial-Status-sidetabs.php') ?>
        <div class="col-sm-8 text-left" >
          <br>
          <div class = "container">
              <div class = "col-sm-10">
                  <!-- LIST OF FINANCIAL STATUS -->
                  <div class="financial-status-table"></div>
              </div>
          </div>
        </div>
        <!-- PROGRESS BAR -->
...
// FYEAR END SELECT
function fetchYearEnd() {
  $.ajax({
    url:"Financial-Status-Year-End-Select.php",
    method:"POST",
    success:function(data){
        $('.financial-status-table').html(data);
      }
  });
}
fetchYearEnd();
