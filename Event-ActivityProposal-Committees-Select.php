...
where student_council.organization_ID = '".$_SESSION['OrgID']."' and ap_status !='Pending' and ap_status !='Returned'";
...
if(mysqli_num_rows($result) > 0 )
{
	...
	<thead>
			<tr>
				<th colspan = "6" class = "text-center">List of <kbd>Activty Proposal</kbd></th>
			</tr>
			<tr>
				<th>Title</th>
				<th>Date</th>
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		echo '<tr class = "'.$stat.'">
					...
					<td>
						<a name = "btn_committeeUP" id = "btn_committeeUP"  data-toggle="modal" data-target="#myModal"
						data-id5="'.$row["ap_id"].'" class="btn btn-sm btn-warning">
						<span class="glyphicon glyphicon-pencil"></span> Committees Update</a>
					</td>
			</tr>';
	}
}
