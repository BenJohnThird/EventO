...
// FOR DISBURSEMENT OF BUDGET DOCUMENTATION
  ...
  $(document).on('click','#btn_del-DisbursementDocu', function (){
      var id = $(this).data("idunique");
      var pass = 'Financial Disbursement';
      var reallyLogout = confirm("Do you really remove this data?");
      if(reallyLogout)
      {
          $.ajax({
          url:"Financial-Disbursement-Delete.php",
          method:"POST",
   ...
   // DELETING OF FOOD
  $(document).on('click','#btn_del-DisbursementFood', function (){
      var id = $(this).data("idunique");
      var pass = 'Financial Disbursement';
      var reallyLogout = confirm("Do you really remove this data?");
      if(reallyLogout)
  ...
  $(document).on('click','#btn_del-DisbursementMaterials', function (){
      var id = $(this).data("idunique");
      var pass = 'Financial Disbursement';
      var reallyLogout = confirm("Do you really remove this data?");
      if(reallyLogout)
  ...
  $(document).on('click','#btn_del-DisbursementHonorarium', function (){
      var id = $(this).data("idunique");
      var pass = 'Financial Disbursement';
      var reallyLogout = confirm("Do you really remove this data?");
      if(reallyLogout)
  ...
  // DELETING OF PROGRAM
  $(document).on('click','#btn_del-DisbursementProgramInvi', function (){
      var id = $(this).data("idunique");
      var pass = 'Financial Disbursement';
      var reallyLogout = confirm("Do you really remove this data?");
      if(reallyLogout)
  ...
  // DELETING OF TOKEN
  $(document).on('click','#btn_del-DisbursementToken', function (){
      var id = $(this).data("idunique");
      var pass = 'Financial Disbursement';
      var reallyLogout = confirm("Do you really remove this data?");
      if(reallyLogout)
  ...
  // DELETING OF OTHERS
  $(document).on('click','#btn_del-DisbursementOthers', function (){
      var id = $(this).data("idunique");
      var pass = 'Financial Disbursement';
      var reallyLogout = confirm("Do you really remove this data?");
      if(reallyLogout)
  ...
  // DELETING OF VENUE
  $(document).on('click','#btn_del-DisbursementVenue', function (){
      var id = $(this).data("idunique");
      var pass = 'Financial Disbursement';
      var reallyLogout = confirm("Do you really remove this data?");
      if(reallyLogout)
  ...
  // DELETING OF ENERGY
  $(document).on('click','#btn_del-DisbursementEnergy', function (){
      var id = $(this).data("idunique");
      var pass = 'Financial Disbursement';
      var reallyLogout = confirm("Do you really remove this data?");
      if(reallyLogout)
  ...
  $(document).on('click','#btn_del-DisbursementTransportation', function (){
      var id = $(this).data("idunique");
      var pass = 'Financial Disbursement';
      var reallyLogout = confirm("Do you really remove this data?");
      if(reallyLogout)
  ...
  $(document).on('click','#btn_del-DisbursementContingency', function (){
      var id = $(this).data("idunique");
      var pass = 'Financial Disbursement';
      var reallyLogout = confirm("Do you really remove this data?");
      if(reallyLogout)
