...
$sql = "SELECT *,ap_financial_disbursement.ID as 'Reserve' FROM ((events INNER JOIN activityproposal ON events.id = activityproposal.events_id)
...
if(mysqli_num_rows($result) > 0 )
{
	...
	<thead>
			<tr>
				<th colspan = "5" class = "text-center">List of <kbd>Financial Disbursement</kbd></th>
			</tr>
			<tr>
				<th>Title</th>
				<th>Date</th>
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		echo '<tr class = "'.$stat.'">
						...
						<td>
							...
							<span class="glyphicon glyphicon-pencil"></span> Make Financial Disbursement</a>
						</td>
			</tr>';
	}
}
