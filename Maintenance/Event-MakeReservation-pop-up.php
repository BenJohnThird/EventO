...
session_start();
$sql = "SELECT place,organization_name,start,end,CountTarget,Description,ap_reservation_main.notes as AP_NOTE,ap_reservation_main.ID as 'Reserve'
...
where ap_reservation_main.ID = '".$_POST["id"]."' group by events.id ";
	...
	echo '
	    ...
	    <form>
					<div class="form-group">
						...
						<input required type = "text" placeholder ="School" id = "organization" readonly class="form-control" value = "'.$row["Organization"].'">
					</div>
	        <div class="form-group">
