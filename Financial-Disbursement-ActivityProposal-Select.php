...
where student_council.organization_ID = '".$_SESSION['OrgID']."'and ap_status = 'Verified | Waiting for the event'";
	...
	while($row = mysqli_fetch_array($result))
	{
		...
		echo '<tr class = "'.$stat.'">
					...
					<td>
						...
						<a id = "btn_startFinancialDisbursement"
						data-id5="'.$row["ap_id"].'" class="btn btn-sm btn-primary">
						<span class="glyphicon glyphicon-pencil"></span> Start Financial Report</a>
					</td>
			</tr>';
	}
}
