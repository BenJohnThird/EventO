...
while($row = mysqli_fetch_array($result)){
	echo '
         ...
         <div class="col-xs-9" class = "text-right">
          ...
          at the end of the activity, atleast of the participants should be able to:
           ...
           <div class="col-xs-2 input-group">
            ...
            value = "'.$row["ObjectivePercent"].'" required min="0" max = "100" placeholder="%">
        ...
        <div class="form-group">
            ...
            <button type= "button" name = "btn_update" class = "btn btn-primary" id ="btn_update" data-idunique = "'.$row["ap_id"].'">Save Changes</button>
            <input name="reset" class = "btn btn" type="reset" id = "btn_reset" />
        </div>
     </form>';
	}
